...
return [
    ...
    */
    ...
    [
        (PHP_VERSION_ID >= 80500 ? Mysql::ATTR_SSL_VERIFY_SERVER_CERT : PDO::MYSQL_ATTR_SSL_VERIFY_SERVER_CERT) => in_array(
            strtolower((string) env('MYSQL_ATTR_SSL_VERIFY_SERVER_CERT', 'false')),
            ['1', 'true', 'yes', 'on'],
            true
        ),
    ],
